...
WorkspacePath          := "/home/DSSE"
ProjectPath            := "/home/SEU-DSSE"
...
LinkOptions            :=  -lzmq -lintel_aes64 -ltomcrypt 
...
Objects0=$(IntermediateDirectory)/Client_DSSE.cpp$(ObjectSuffix) $(IntermediateDirectory)/Krawczyk128_KDF.cpp$(ObjectSuffix) $(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix) $(IntermediateDirectory)/DSSE.cpp$(ObjectSuffix) $(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(ObjectSuffix) $(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix) $(IntermediateDirectory)/DSSE_Trapdoor.cpp$(ObjectSuffix) $(IntermediateDirectory)/DSSE_FileCrypt.cpp$(ObjectSuffix) $(IntermediateDirectory)/MasterKey.cpp$(ObjectSuffix) $(IntermediateDirectory)/DSSE_KeyGen.cpp$(ObjectSuffix) \
	$(IntermediateDirectory)/Server_DSSE.cpp$(ObjectSuffix) $(IntermediateDirectory)/main_client.cpp$(ObjectSuffix) $(IntermediateDirectory)/DSSE_Crypto.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/Client_DSSE.cpp$(ObjectSuffix): Client_DSSE.cpp $(IntermediateDirectory)/Client_DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "Client_DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Client_DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Krawczyk128_KDF.cpp$(ObjectSuffix): Krawczyk128_KDF.cpp $(IntermediateDirectory)/Krawczyk128_KDF.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "Krawczyk128_KDF.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Krawczyk128_KDF.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix): Miscellaneous.cpp $(IntermediateDirectory)/Miscellaneous.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "Miscellaneous.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE.cpp$(ObjectSuffix): DSSE.cpp $(IntermediateDirectory)/DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(ObjectSuffix): DSSE_Hashmap_Key_Class.cpp $(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "DSSE_Hashmap_Key_Class.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix): Keyword_Extraction.cpp $(IntermediateDirectory)/Keyword_Extraction.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "Keyword_Extraction.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Trapdoor.cpp$(ObjectSuffix): DSSE_Trapdoor.cpp $(IntermediateDirectory)/DSSE_Trapdoor.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "DSSE_Trapdoor.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Trapdoor.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_FileCrypt.cpp$(ObjectSuffix): DSSE_FileCrypt.cpp $(IntermediateDirectory)/DSSE_FileCrypt.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "DSSE_FileCrypt.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_FileCrypt.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/MasterKey.cpp$(ObjectSuffix): MasterKey.cpp $(IntermediateDirectory)/MasterKey.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "MasterKey.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/MasterKey.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_KeyGen.cpp$(ObjectSuffix): DSSE_KeyGen.cpp $(IntermediateDirectory)/DSSE_KeyGen.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "DSSE_KeyGen.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_KeyGen.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Server_DSSE.cpp$(ObjectSuffix): Server_DSSE.cpp $(IntermediateDirectory)/Server_DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "Server_DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Server_DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main_client.cpp$(ObjectSuffix): main_client.cpp $(IntermediateDirectory)/main_client.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "main_client.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main_client.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main_server.cpp$(ObjectSuffix): main_server.cpp $(IntermediateDirectory)/main_server.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "main_server.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main_server.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Crypto.cpp$(ObjectSuffix): DSSE_Crypto.cpp $(IntermediateDirectory)/DSSE_Crypto.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "DSSE_Crypto.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Crypto.cpp$(ObjectSuffix) $(IncludePath)
