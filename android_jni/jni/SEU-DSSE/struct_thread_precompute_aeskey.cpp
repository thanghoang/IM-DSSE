...
THREAD_PRECOMPUTE_AESKEY::THREAD_PRECOMPUTE_AESKEY(unsigned char* aes_keys, TYPE_INDEX idx, int dim, TYPE_COUNTER* block_counter_arr,unsigned char* row_keys, MasterKey* masterKey)
{
    this->idx = idx;
    this->dim = dim;
