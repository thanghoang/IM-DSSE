...
WorkspacePath          := "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC"
ProjectPath            := "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE"
...
$(IntermediateDirectory)/Client_DSSE.cpp$(ObjectSuffix): Client_DSSE.cpp $(IntermediateDirectory)/Client_DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/Client_DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Client_DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Krawczyk128_KDF.cpp$(ObjectSuffix): Krawczyk128_KDF.cpp $(IntermediateDirectory)/Krawczyk128_KDF.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/Krawczyk128_KDF.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Krawczyk128_KDF.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix): Miscellaneous.cpp $(IntermediateDirectory)/Miscellaneous.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/Miscellaneous.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE.cpp$(ObjectSuffix): DSSE.cpp $(IntermediateDirectory)/DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(ObjectSuffix): DSSE_Hashmap_Key_Class.cpp $(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/DSSE_Hashmap_Key_Class.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix): Keyword_Extraction.cpp $(IntermediateDirectory)/Keyword_Extraction.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/Keyword_Extraction.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Trapdoor.cpp$(ObjectSuffix): DSSE_Trapdoor.cpp $(IntermediateDirectory)/DSSE_Trapdoor.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/DSSE_Trapdoor.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Trapdoor.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_FileCrypt.cpp$(ObjectSuffix): DSSE_FileCrypt.cpp $(IntermediateDirectory)/DSSE_FileCrypt.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/DSSE_FileCrypt.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_FileCrypt.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/MasterKey.cpp$(ObjectSuffix): MasterKey.cpp $(IntermediateDirectory)/MasterKey.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/MasterKey.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/MasterKey.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_KeyGen.cpp$(ObjectSuffix): DSSE_KeyGen.cpp $(IntermediateDirectory)/DSSE_KeyGen.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/DSSE_KeyGen.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_KeyGen.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Server_DSSE.cpp$(ObjectSuffix): Server_DSSE.cpp $(IntermediateDirectory)/Server_DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/Server_DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Server_DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main_client.cpp$(ObjectSuffix): main_client.cpp $(IntermediateDirectory)/main_client.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/main_client.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main_client.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Crypto.cpp$(ObjectSuffix): DSSE_Crypto.cpp $(IntermediateDirectory)/DSSE_Crypto.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/DSSE_Crypto.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Crypto.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/struct_thread_getData.cpp$(ObjectSuffix): struct_thread_getData.cpp $(IntermediateDirectory)/struct_thread_getData.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/struct_thread_getData.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/struct_thread_getData.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/struct_thread_precompute_aeskey.cpp$(ObjectSuffix): struct_thread_precompute_aeskey.cpp $(IntermediateDirectory)/struct_thread_precompute_aeskey.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/IM-DSSE/pc_src/TISSEC/SEU-DSSE/struct_thread_precompute_aeskey.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/struct_thread_precompute_aeskey.cpp$(ObjectSuffix) $(IncludePath)
